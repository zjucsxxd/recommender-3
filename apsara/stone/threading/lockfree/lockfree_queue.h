...
#ifndef STONE_THREADING_LOCKFREE_LOCKFREE_QUEUE_H
#define STONE_THREADING_LOCKFREE_LOCKFREE_QUEUE_H

// It's difficult to understand this implementation. Please refer to:
...
#endif // STONE_THREADING_LOCKFREE_LOCKFREE_QUEUE_H

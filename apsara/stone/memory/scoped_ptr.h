...
#ifndef STONE_MEMORY_SCOPED_PTR_H
#define STONE_MEMORY_SCOPED_PTR_H
...
private:
    ...
    // With the meaning of scoped_array, the following operations make no
    // sense so disable them.
    // disable copy constructor, and assign operator
    template<typename T1, typename Deletor1>
...
#endif // STONE_MEMORY_SCOPED_PTR_H
